...
# WIP - How to upgrade to Circuit Python for Pico 2W 
*Guide based on [Adafruit update page](https://learn.adafruit.com/getting-started-with-raspberry-pi-pico-circuitpython), check this page for more in-depth guidance*.  
...
1. Find out which version of CircuitPython you are running currently, you can use step a **OR** step b
...
1. Double-click the RESET button, the drive disappears and reappears as: ????    
...
1. Download the latest stable version of CircuitPython at [this page](https://circuitpython.org/board/itsybitsy_m4_express/) by pressing the ```Download .uf2 now``` button.
<img src="assets/M4circuitpython.png" alt="" width="100%"/>

1. Drag the .uf2 file to the ITSYM4BOOT drive, the drive disappears and reappears as: CIRCUITPY  
