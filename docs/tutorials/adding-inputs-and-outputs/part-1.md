...
2. Temporarily disconnect your microcontroller from the computer. Use a Grove cable to connect the Touch Sensor to the pin connector labeled **`D2`** on the Expander Board, as shown in the illustration above.
