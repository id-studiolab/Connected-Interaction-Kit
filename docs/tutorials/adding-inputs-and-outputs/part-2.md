...
![Illustration of the proper setup of touch sensor and vibration motor with the microcontroller](assets/io_touch_buzz.svg)


1. As with the Touch Sensor, begin by connecting your Vibration Motor using a Grove cable. Connect it to pin **`D6`**, as shown in the illustration.
