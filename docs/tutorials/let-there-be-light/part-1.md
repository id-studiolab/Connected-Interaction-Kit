...
1. Using the USB cable included in the kit, connect the Pico to your computer. It will appear in your computer's file manager as a storage device called `CIRCUITPY`. 
...
{:.note}
Once you store changes in `code.py` to the `CIRCUITPY` drive, your Pico will begin running the new code immediately. Changes will persist even after disconnecting the Pico from your computer.
