...
1. Using the USB cable included in the kit, connect the microcontroller to your computer. It will appear in your computer's file manager as a storage device called `CIRCUITPY`. 
