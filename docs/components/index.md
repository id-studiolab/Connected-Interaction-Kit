...
# Components
 ...
 The core of the Connected Interaction Kit is a CircuitPython microcontroller board. With the help of a bit of code, this microcontroller allows you to interact with and perceive the outside world using various electronic sensors and actuators.
